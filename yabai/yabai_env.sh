...
apps_mgoff_normal="(Calculator|iStat Menus|Hammerspoon|BetterDisplay|GIMP|Notes|System Preferences|System Settings|Activity Monitor|App StoreSoftware Update|CleanShot X|Karabiner-Elements|TestRig|Gemini|Raycast|OBS Studio|QuickTime Player|Cisco Packet Tracer 8.2.2|Cisco Packet Tracer|Stickies|kitty|Elmedia Player)"
